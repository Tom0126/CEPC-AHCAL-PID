...
# adjustment on https://github.com/pytorch/vision/blob/main/torchvision/models/googlenet.py
import warnings
...
class GoogLeNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = conv_block(self.in_channel, 64, kernel_size = 7, stride = 2, padding = 3)
        ...
        if aux_logits:
            self.aux1 = inception_aux_block(512, n_classes, dropout=dropout_aux)
            self.aux2 = inception_aux_block(528, n_classes, dropout=dropout_aux)
        else:
